...
describe.skip('EmojiExport Component', () => {
  ...
  it('calls clipboard API when exporting as plain text', async () => {
    ...
    expect(navigator.clipboard.writeText).toHaveBeenCalledWith('emoji1.png\nemoji2.png');
    expect(screen.getByText('Copied filenames to clipboard!')).toBeInTheDocument();
  });
  ...
  it('calls clipboard API when exporting as CSS', async () => {
    ...
    expect(navigator.clipboard.writeText).toHaveBeenCalledWith(expect.stringContaining('.emoji-1'));
